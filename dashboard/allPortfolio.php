              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><img height="200px" src="upload/<?php echo $d['img'] ?>"></td>
                    <td><a href="updatePortfolio.php?proid=<?php echo $d['id']; ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="deletePortfolio.php?proid=<?php echo $d['id']; ?>" class="btn btn-danger">Delete</a></td>
                  </tr>
                  <?php endforeach; ?>
